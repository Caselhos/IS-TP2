...
export default function MusicsPage() {
    ...
    fetch(`http://localhost:20001/Musics/`)
    ...
    return (
        <>
            <h1 sx={{fontSize: "100px"}}>Musics</h1>
                        ...
                        {data ?
                          data.map((row) => (
                            <TableRow key={row.id}>
                              ...
                              <TableCell component="td" align="center" scope="row">{row.spotify_id}</TableCell>
                              <TableCell component="td" align="center" scope="row">{row.album_id}</TableCell>
                            </TableRow>
                          )) :
                          <TableRow>
                            <TableCell colSpan={4}>
